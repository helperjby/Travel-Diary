...
public class DiaryService {
     ...
     */
    public List<WritingDiary> getUserDiaries(Integer userId) {
        // 사용자 ID로 사용자 조회
     ...
     * @return 조회된 일기 엔터티
     */
    public WritingDiary getDiaryById(Integer diaryId, Integer userId) {
     ...
     */
    public List<WritingDiary> getDiariesByDate(LocalDate date, Integer userId) {
        // 사용자 ID로 사용자 조회
        Users user = userRepository.findById(userId).orElseThrow(() -> new RuntimeException("User not found"));
     ...
     */
    public List<WritingDiary> getDiariesByPeriod(LocalDate startDate, LocalDate endDate, Integer userId) {
        // 사용자 ID로 사용자 조회
        Users user = userRepository.findById(userId).orElseThrow(() -> new RuntimeException("User not found"));
